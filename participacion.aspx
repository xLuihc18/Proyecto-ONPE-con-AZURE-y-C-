<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="participacion.aspx.cs" Inherits="ProyectoONPE.participacion" %>
<!DOCTYPE html> 
<html>
    <head>
      ...
      <header>
        <div class="container">
          <div class="pull-left logo-onpe">
            <div class="pull-left">
              <a href="index.aspx"><img src="images/onpe-trans.png"></a>
            </div>
            <div class="pull-left">
            ...
            <div class="row">
              <div class="col-xs-12 col-md-3">
                <div class="menu-interna">
                  <ul>
                    <li><a href="participacion_total.aspx" class="act-izq">TOTAL</a></li>
                  </ul>
                </div>
              </div>
              <div class="col-xs-12 col-md-9" id="impreso">
                <div class="contenido-interna">
                  ...
                  <div class="col-xs-12 line pbot30">
                    ...
                    <div class="col-xs-12 col-md-6">
                      <p class="subtitle">ELECTORES HÁBILES: <asp:Label ID="lblHabiles" runat="server" Text="0"></asp:Label></p>
                      <div id="page-wrap">
                        <table class="table09_2" cellspacing="0">
                          ...
                          <tbody>
                            <tr>
                              <td>TOTAL: <asp:Label ID="lblParticipacionTotal" runat="server" Text="0"></asp:Label></td>
                              <td>TOTAL: <asp:Label ID="lblAusentismoTotal" runat="server" Text="0"></asp:Label></td>
                            </tr>
                            <tr>
                              <td>% TOTAL: <asp:Label ID="lblParticipacionPorcentaje" runat="server" Text="0"></asp:Label>%</td>
                              <td>% TOTAL: <asp:Label ID="lblAusentismoPorcentaje" runat="server" Text="0"></asp:Label>%</td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
                  ...
                  <div class="col-xs-12 pbot30 ptop20">
                    <div class="col-xs-12 col-md-6">
                      <a href="participacion_total.aspx?id=Extranjero"><img src="images/icono_extranjero.jpg" class="img-responsive"></a>
                    </div>
                    <div class="col-xs-12 col-md-6">
                      <a href="participacion_total.aspx?id=Nacional"><img src="images/icono_nacional.jpg" class="img-responsive"></a>
                    </div>
                  </div>
                </div>
              </div>
